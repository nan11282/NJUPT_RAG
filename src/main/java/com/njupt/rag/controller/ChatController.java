...
public class ChatController {
    ...
    public Flux<String> streamChat(
        ...
        // 获取回答流
        Flux<String> answerFlux = ragChatService.streamChat(question, sessionId);
     ...
     * 支持多轮对话，通过 sessionId 维护会话历史。
     *
     * @param request 包含用户问题和会话 ID 的请求体
    ...
    public Map<String, String> chat(@RequestBody ChatRequest request) {
        ...
        String answer = ragChatService.chat(request.question(), sessionId);
     ...
     * @param sessionId 会话 ID
     */
    public record SaveHistoryRequest(String question, String answer, String sessionId) {
    }
}
